...
- **Alexander Cech** - PUDDraft and WarDraft.
...
- **Mark Adler** - zlib's `contrib/blast/blast.c`. The PKWARE DCL decoder in
  `src/PUDForgeCore/mpq.cpp` is derived from it, under the zlib licence, and
  carries its attribution in place.
